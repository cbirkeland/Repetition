...
namespace EfSamurai.App
{
    class Program
    {
        ...
        private static void InvestigateFindAndWhere(int samuraiId)
        {
            ...
            // Om find anropas med samma id flera gånger + den redan finns => inget anrop sker mot databasen
        ...
        private static void InvestigateIQuerable()
        {
            ...
            ch.Green($"expression.ToString() = {expression.ToString()}"); // ==> ger själva frågan
